...
# ✅ 載入 maze3_prim.py
env_path = "C:/Users/seana/maze/env/maze3_prim.py"
spec = importlib.util.spec_from_file_location("maze3_prim", env_path)
maze3_prim = importlib.util.module_from_spec(spec)
spec.loader.exec_module(maze3_prim)
maze3_prim.register_maze3_prim_env()


# ✅ 初始化環境
env = maze3_prim.Maze3PrimEnv(render_mode="human")
...
save_path = f"C:/Users/seana/maze/outputs/path_maze3_prim_{timestamp}.npy"
